...
lazy_static! {
    static ref NORMAL_TESTS: Vec<ScoreTestCase> = vec![
        ...
        ScoreTestCase {
            wining_tile_ch: '🀓',
            hand_str: "🀚🀛🀜🀒🀔🀠🀠",
            meld: vec![('🀍', TestMeld::Chow), ('🀄', TestMeld::Ankan),],
            omotedora_str: "🀟",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
        ...
        ScoreTestCase {
            wining_tile_ch: '🀐',
            hand_str: "🀉🀉🀉🀐🀒🀒🀒",
            meld: vec![('🀛', TestMeld::Ankan), ('🀝', TestMeld::Chow),],
            omotedora_str: "🀑",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
        ...
        ScoreTestCase {
            wining_tile_ch: '🀅',
            hand_str: "🀏🀏🀚🀛🀜🀅🀅",
            meld: vec![('🀔', TestMeld::Chow), ('🀐', TestMeld::Chow),],
            omotedora_str: "🀆",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
        ...
        ScoreTestCase {
            wining_tile_ch: '🀌',
            hand_str: "🀉🀊🀋🀌🀝🀞🀟",
            meld: vec![('🀔', TestMeld::Chow), ('🀎', TestMeld::Pung),],
            omotedora_str: "🀍",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
        ...
        ScoreTestCase {
            wining_tile_ch: '🀆',
            hand_str: "🀇🀈🀉🀁🀁🀁🀆",
            meld: vec![('🀀', TestMeld::Pung), ('🀅', TestMeld::Pung),],
            omotedora_str: "",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
        ...
        ScoreTestCase {
            wining_tile_ch: '🀍',
            hand_str: "🀎🀏🀚🀚🀕🀖🀗",
            meld: vec![('🀋', TestMeld::Ankan), ('🀅', TestMeld::Pung),],
            omotedora_str: "🀆",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
    ...
    static ref YAKUMAN_TESTS: Vec<ScoreTestCase> = vec![
        ...
        ScoreTestCase {
            wining_tile_ch: '🀕',
            hand_str: "🀑🀒🀓🀕🀕🀗🀗",
            meld: vec![('🀅', TestMeld::Pung), ('🀑', TestMeld::Chow),],
            omotedora_str: "",
            uradora_str: "",
            nhonba: 0,
            nriichi: 0,
